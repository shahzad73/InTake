...
public partial class print : System.Web.UI.Page
{
    ...
    private void GenerateTableFieldsObjects(List<DBItem> lst)
    {
        ...
        itm = new DBItem("ClientInjuryClassificationSoftTissue", "label", "ClientInjuryClassificationSoftTissue", "string", false); lst.Add(itm); itm = new DBItem("ClientInjuryClassificationRoadRash", "label", "ClientInjuryClassificationRoadRash", "string", false); lst.Add(itm); itm = new DBItem("ClientInjuryClassificationFractures", "label", "ClientInjuryClassificationFractures", "string", false); lst.Add(itm); itm = new DBItem("ClientInjuryClassificationHead", "label", "ClientInjuryClassificationHead", "string", false); lst.Add(itm); itm = new DBItem("ClientInjuryClassificationOrganInjuries", "label", "ClientInjuryClassificationOrganInjuries", "string", false); lst.Add(itm); lst.Add(itm); itm = new DBItem("ClientInjuryClassificationOther", "label", "ClientInjuryClassificationOther", "string", false); lst.Add(itm);
